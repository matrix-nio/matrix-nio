...
class Model(BaseModel):
    content: Optional[List[PushRule]] = None
    override: Optional[List[PushRule]] = None
    room: Optional[List[PushRule]] = None
    sender: Optional[List[PushRule]] = None
    underride: Optional[List[PushRule]] = None
