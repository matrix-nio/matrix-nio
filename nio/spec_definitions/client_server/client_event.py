...
class Unsigned(BaseModel):
    redacted_because: Optional[Any] = Field(
        None,
        examples=[
            {
...
class ClientEventWithoutRoomId(BaseModel):
    ...
    unsigned: Optional[Unsigned1] = Field(
        None,
...
class ClientEvent(ClientEventWithoutRoomId):
    room_id: str = Field(
        ...
        examples=["!jEsUZKDJdhlrceRyVU:example.org"],
    )
