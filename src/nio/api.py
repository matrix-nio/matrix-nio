...
class Api_old:
    ...
    def discovery_info() -> Tuple[str, str]:
        ...
        return "GET", Api_old._build_path(path, base_path="")
    ...
    def login_info() -> Tuple[str, str]:
        ...
        return "GET", Api_old._build_path(path)
    ...
    def register(
        ...
        return "POST", Api_old._build_path(path), Api_old.to_json(content_dict)
    ...
    def login_raw(
        ...
        return "POST", Api_old._build_path(path), Api_old.to_json(auth_dict)
    ...
    def logout(
        ...
        return "POST", Api_old._build_path(path, query_parameters)
    ...
    def sync(
        ...
        return "GET", Api_old._build_path(path, query_parameters)
    ...
    def room_send(
        ...
        return "PUT", Api_old._build_path(path, query_parameters), Api_old.to_json(body)
    ...
    def space_get_hierarchy(
        ...
        return "GET", Api_old._build_path(path, query_parameters, MATRIX_API_PATH_V1)
    ...
    def room_get_event_relations(
        ...
        return "GET", Api_old._build_path(path, query_parameters, "/_matrix/client/v1")
    ...
    def room_kick(
        ...
        return (
            "POST",
            Api_old._build_path(path, query_parameters),
            Api_old.to_json(body),
        )
    ...
    def join(access_token: str, room_id: str) -> Tuple[str, str]:
        ...
        # TODO: Should we return an empty json as the data for the request?
    ...
    def room_delete_alias(access_token: str, room_alias: str) -> Tuple[str, str]:
        ...
        return "DELETE", Api_old._build_path(path, query_parameters)
    ...
    def content_repository_config(access_token: str) -> Tuple[str, str]:
        ...
        return "GET", Api_old._build_path(path, query_parameters, MATRIX_MEDIA_API_PATH)
    ...
    def upload(
        ...
        return "POST", Api_old._build_path(
    ...
    def public_rooms(
        ...
        if method == "GET":
            ...
            if since is not None:
                query_parameters["since"] = since
            return method, Api_old._build_path(path, query_parameters), None
        if method == "POST":
    ...
    def get_openid_token(access_token: str, user_id: str) -> Tuple[str, str, str]:
        ...
        return "POST", Api_old._build_path(path, query_parameters), Api.to_json({})
...
class Api_new:
    ...
    def discovery_info() -> HttpRequest:
        ...
        return HttpRequest("GET", Api_new._build_path(path, base_path=""))
    ...
    def login_info() -> HttpRequest:
        ...
        return HttpRequest("GET", Api_new._build_path(path))
    ...
    def register(
        ...
        return HttpRequest(
            "POST", Api_new._build_path(path), {}, Api_new.to_json(content_dict)
        )
    ...
    def login_raw(
        ...
        return HttpRequest(
            "POST", Api_new._build_path(path), data=Api_new.to_json(auth_dict)
        )
    ...
    def logout(
        ...
        return HttpRequest("POST", Api_new._build_path(path), headers)
    ...
    def sync(
        ...
        return HttpRequest("GET", Api_new._build_path(path, query_parameters), headers)
    ...
    def room_send(
        ...
        return HttpRequest(
            "PUT", Api_new._build_path(path), headers, Api_new.to_json(body)
        )
    ...
    def space_get_hierarchy(
        ...
        return HttpRequest(
            "GET",
            Api_new._build_path(path, query_parameters, MATRIX_API_PATH_V1),
            headers,
        )
    ...
    def direct_room_list(access_token: str, user_id: str) -> HttpRequest:
        ...
        return HttpRequest("GET", Api_new._build_path(path), headers)
    ...
    def room_get_event_relations(
        ...
        return HttpRequest(
            "GET",
            Api_new._build_path(path, query_parameters, "/_matrix/client/v1"),
            headers,
        )
    ...
    def room_kick(
        ...
        return HttpRequest(
            "POST", Api_new._build_path(path), headers, Api_new.to_json(body)
        )
    ...
    def join(access_token: str, room_id: str) -> HttpRequest:
        ...
        # [1] https://spec.matrix.org/v1.11/client-server-api/#post_matrixclientv3joinroomidoralias
        return HttpRequest(
            "POST", Api_new._build_path(path), headers, Api_new.to_json({})
        )
    ...
    def keys_query(
        ...
        return HttpRequest(
            "POST", Api_new._build_path(path), headers, Api_new.to_json(content)
        )
    ...
    def to_device(
        ...
        return HttpRequest(
            "PUT", Api_new._build_path(path), headers, Api_new.to_json(content)
        )
    ...
    def room_delete_alias(access_token: str, room_alias: str) -> HttpRequest:
        ...
        return HttpRequest("DELETE", Api_new._build_path(path), headers)
    ...
    def content_repository_config(access_token: str) -> HttpRequest:
        ...
        return HttpRequest(
            "GET", Api_new._build_path(path, base_path=MATRIX_MEDIA_API_PATH), headers
        )
    ...
    def upload(
        ...
        return HttpRequest(
            "POST",
            Api_new._build_path(path, query_parameters, MATRIX_LEGACY_MEDIA_API_PATH),
            headers,
        )
    ...
    def download(
        ...
        return HttpRequest(
            "GET",
            Api_new._build_path(path, query_parameters, MATRIX_MEDIA_API_PATH),
            headers,
        )
    ...
    def public_rooms(
        ...
        if method == "GET":
            ...
            if since is not None:
                query_parameters["since"] = since
            return HttpRequest(
                method, Api_new._build_path(path, query_parameters), headers, None
            )
        if method == "POST":
            content: Dict[str, Any] = {}
            if limit:
            ...
            return HttpRequest(
                method,
                Api_new._build_path(path, query_parameters),
                headers,
                Api_new.to_json(content),
            )
